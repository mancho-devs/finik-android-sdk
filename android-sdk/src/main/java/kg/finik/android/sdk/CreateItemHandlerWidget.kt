...
enum class TextScenario(val rawValue: String) : Parcelable {
    ...
    companion object {
        fun fromRawValue(raw: String): TextScenario? = entries.find { it.rawValue == raw }
    }
}
...
enum class FinikSdkLocale(val rawValue: String) : Parcelable {
    ...
    companion object {
        fun fromRawValue(raw: String): FinikSdkLocale? = entries.find { it.rawValue == raw }
    }
}
...
enum class PaymentMethod(val rawValue: String) : Parcelable {
    ...
    companion object {
        fun fromRawValue(raw: String): PaymentMethod? = entries.find { it.rawValue == raw }
    }
}
